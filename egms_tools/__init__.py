...
from .heat import synthetic_heat_components, city_heat_stats, landsat_lst_image, landsat_lst_points
...
__all__ = ["GERMANY", "HOTSPOTS", "velocity_field", "lonlat_to_xy",
           ...
           "synthetic_heat_components", "city_heat_stats", "landsat_lst_image", "landsat_lst_points",
